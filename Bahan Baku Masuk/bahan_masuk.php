...
$data_tabel = select("SELECT * FROM t_bahan_masuk_keluar WHERE id_stok_masuk IS NOT NULL" );
        ...
        <table id="data-table" class="table table-bordered table-striped"> <!--Tipe Border dari bootstrap-->
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button class="btn btn-light btn-sm"  data-bs-toggle="modal" data-bs-target="#editModal<?= $tabel['id_stok_masuk'];?>"><i class="fas fa-edit"></i></button> <!-- Icon edit-->
                <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $tabel['id_transaksi']; ?>"><i class="fa-regular fa-trash-can" style="color: #dd1d1d;"></i></button> <!-- Icon Sampah/delete-->
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
